...
import com.sym.constant.HttpMethodConstant;
import com.sym.constant.JavaConstant;
import com.sym.constant.SpringMVCConstant;
import com.sym.constant.SwaggerConstants;
import com.sym.dto.YapiApiDTO;
import com.sym.dto.YapiHeaderDTO;
import com.sym.dto.YapiPathVariableDTO;
import com.sym.dto.YapiQueryDTO;
import com.sym.upload.UploadYapi;
import com.sym.util.DesUtil;
import com.sym.util.FileToZipUtil;
import com.sym.util.FileUnZipUtil;
import com.sym.util.PsiAnnotationSearchUtil;
...
public class BuildJsonForYapi {
        ...
        if (psiAnnotationMethod != null) {
            ...
            if (psiNameValuePairs != null && psiNameValuePairs.length > 0) {
                for (PsiNameValuePair psiNameValuePair : psiNameValuePairs) {
                    //获得方法上的路径
                    if (Objects.isNull(psiNameValuePair.getName()) || "value".equals(psiNameValuePair.getName()) || "path".equals(psiNameValuePair.getName())) {
     ...
     * @return
     */
    public ArrayList<YapiApiDTO> actionPerformedList(String className, PsiFile psiFile, Project project, String attachUpload, String returnClass) {
